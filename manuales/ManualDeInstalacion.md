...
1. Diríjase al repositorio oficial en GitHub:  
   `[Enlace de descarga]`
2. En la sección **Releases**, descargue la última versión del archivo ejecutable (`.exe`).
...
![alt text](imagenes/AlertaWindows.png)
...
![alt text](imagenes/CreacionAccesoDirecto.png)
...
![alt text](imagenes/tamanoAplicacion.png)  
![alt text](imagenes/administradorTareas.png)
